...
public class CarriageTypeRepositoryMocks
{
    ...
    {
        var carriageTypeFist = new CarriageType { Name = GetCarriageTypes()[0].Name, NumberOfSeats = 5, IsDeleted = false };
        yield return new TestCaseData(1, carriageTypeFist);

        var carriageTypeSecond = new CarriageType { Name = GetCarriageTypes()[1].Name, NumberOfSeats = 7, IsDeleted = true };
        yield return new TestCaseData(2, carriageTypeSecond);

        var carriageTypeThird = new CarriageType { Name = GetCarriageTypes()[2].Name, NumberOfSeats = 8, IsDeleted = false };
